...
public interface ObjectMixin<T extends ObjectMixin<T>> {
    ...
    default boolean _equals(final Object obj) {
        ...
        // Must be an ObjectMixin since the class is the same as this class
        final ObjectMixin thatAutoObject = (ObjectMixin) obj; 

        return Arrays.equals(members(), thatAutoObject.members());
    }
...
//        final ObjectSupport thatAutoObject = (ObjectSupport) obj;
        @SuppressWarnings("rawtypes")
