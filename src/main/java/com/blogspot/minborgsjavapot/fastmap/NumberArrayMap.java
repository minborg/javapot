...
/**
 * This map does not permit null values. It is not thread-safe and must be
 * synchronized externally if used by several threads simultaneously.
 *
 * @author pemi
 * @param <K>
 * @param <V>
